<div class="toast-container position-static">
    ...
    <div class="position-fixed bottom-0 end-0 p-3" style="z-index: 11">
        <div class="toast align-items-center text-bg-danger border-0" role="alert" aria-live="assertive" aria-atomic="true" id="add-fail-toast">
            <div class="d-flex">
        ...
        <div class="toast align-items-center text-bg-danger border-0" role="alert" aria-live="assertive" aria-atomic="true" id="password-invalid-toast">
            <div class="d-flex">
                <div class="toast-body">
                    Invalid Password ! Password Character Length must minimum 8 and maximum 12 characters.
                </div>
                <button type="button" class="btn-close btn-close-white me-2 m-auto" data-bs-dismiss="toast" aria-label="Close"></button>
            </div>
        </div>
        ...
        <div class="toast align-items-center text-bg-danger border-0" role="alert" aria-live="assertive" aria-atomic="true" id="username-invalid-toast">
            <div class="d-flex">
                <div class="toast-body">
                    Invalid Username ! Username Character Length must minimum 5 and maximum 15 characters.
                </div>
                <button type="button" class="btn-close btn-close-white me-2 m-auto" data-bs-dismiss="toast" aria-label="Close"></button>
            </div>
        </div>
