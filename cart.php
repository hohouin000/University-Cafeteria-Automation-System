                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-4 col-md-6 mb-4 mb-lg-0">
                                                ...
                                                <div class="d-flex align-items-end justify-content-end">
                                                    <a href="update-cart.php?store_id=<?php echo $arr["store_id"]; ?>&mitem_id=<?php echo $row["mitem_id"]; ?>" button type="button" class="btn btn-primary btn-sm me-1 mb-2" data-mdb-toggle="tooltip" title="Edit item">
