    ...
    <div class="card">
        ...
        ?>
            ...
            <div class="alert alert-danger d-flex align-items-center mt-5" role="alert">
                ...
                <div>
                    Failed to send digital receipt. Digital receipt may have been sent to your email previously or internet is unavailable. Please check your email. if you did not get your receipt, please ask from the counter.
                </div>
            </div>
        <?php
        }
